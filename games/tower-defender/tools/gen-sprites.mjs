...
const STAGED = [
  ...
  { id: 'madai', stages: [
    ...
    '三国蜀汉名将·马岱(名将统帅):西凉骑帅,锦铠白袍,骑战马,背旗,手持寒光斩将大刀,沉稳冷峻西凉骑帅气度。骑乘全身像,人马都完整。' + PERSON,
    '三国蜀汉寒光神将·马岱(封神):寒光神刀,刀身寒芒罡气流动,沉决冷峻神情,骑战马(坐骑身形沉稳,神光华聚于人身),效果全部画在角色身上,纯白背景无场景。' + PERSON,
  ] },
  { id: 'guanping', stages: [
