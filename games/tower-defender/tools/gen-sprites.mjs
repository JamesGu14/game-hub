...
const UNITS = [
  ...
  { cat: 'generals', id: 'zhang', desc: '三国蜀汉五虎上将·张飞：豹头环眼，虬髯如戟，黝黑魁梧，身披黑甲，手持丈八蛇矛，怒目圆睁。' },
  { cat: 'generals', id: 'guan', desc: '三国蜀汉五虎上将·关羽：面如重枣的红脸，长髯及胸，丹凤眼，绿色战袍金甲，手持青龙偃月刀，威严。' },
  { cat: 'generals', id: 'zhao', desc: '三国蜀汉五虎上将·赵云：年轻俊朗，白袍银甲，手持银枪，英姿飒爽。' },
  { cat: 'generals', id: 'ma', desc: '三国蜀汉五虎上将·马超：西凉锦马超，兽面狮盔，银甲白袍，手持长枪，英武剽悍。' },
  { cat: 'generals', id: 'zhuge', desc: '三国蜀汉军师·诸葛亮：羽扇纶巾，八卦道袍，手持白羽扇，儒雅智者，无甲。' },
