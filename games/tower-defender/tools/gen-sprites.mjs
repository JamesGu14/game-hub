...
const UNITS = [
  ...
  // —— [需求①②] 吴/魏 专属步卒立绘 + 新兵种骑兵(魏吴两套)。生成:node tools/gen-sprites.mjs wu_footman wei_footman wu_cavalry wei_cavalry(锚 huang 保画风) ——
  { cat: 'enemies', id: 'wu_footman', desc: '三国东吴步卒（敌军小兵）：青蓝战袍配皮甲，手持环首刀与圆藤盾，江东水乡子弟兵，干练精悍。' },
  { cat: 'enemies', id: 'wei_footman', desc: '三国曹魏步卒（敌军小兵）：玄黑配赭红战袍铁甲，手持长戟，中原雄师正卒，肃整威武。' },
  { cat: 'enemies', id: 'wu_cavalry', desc: '三国东吴丹阳劲骑（敌军骑兵）：青蓝具装骑兵骑乘战马，手持马槊，作正面冲锋姿态，江东精锐骑士，人马都完整。' },
  { cat: 'enemies', id: 'wei_cavalry', desc: '三国曹魏具装铁骑（敌军重骑兵）：玄铁重甲骑兵骑乘披马铠的战马，手持长矛，作正面冲锋姿态，虎豹骑级精锐重骑，人马都完整。' },
