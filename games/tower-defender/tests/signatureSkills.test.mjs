...
{
  const t = createTower('guan', { x: 0, y: 0 }); t.px = 100; t.py = 100; t.level = BAL.SIGNATURE_LEVEL;
...
{
  const t = createTower('zhang', { x: 0, y: 0 }); t.px = 100; t.py = 100; t.level = BAL.SIGNATURE_LEVEL;
...
// 无目标 → 不放（不消耗 CD）
{
  const t = createTower('guan', { x: 0, y: 0 }); t.level = BAL.SIGNATURE_LEVEL; t.target = null;
