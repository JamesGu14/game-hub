...
assert.equal(calcDamage({ level: 1 }, GENERALS.huang, heavy, noCrit).dmg, 7 * 0.6, '物理×0.6');
...
assert.equal(calcDamage({ level: 1 }, GENERALS.huang, teng, noCrit).dmg, 7 * 0.5, '藤甲抗物理×0.5');
