...
import { BAL } from '../data/balance.js';   // 仅取 MAX_TOWER_LEVEL（纯常量,无循环依赖）
...
export const MANIFEST = {
  ...
  // —— [形象演进 spec §6] 12 将 × 2 阶(L4威将/L5神将;缺图→ generalSprite 自动回退 L3)——
  gen_huang_4: 'assets/sprites/generals/huang_4.png', gen_huang_5: 'assets/sprites/generals/huang_5.png',
  gen_zhang_4: 'assets/sprites/generals/zhang_4.png', gen_zhang_5: 'assets/sprites/generals/zhang_5.png',
  gen_guan_4: 'assets/sprites/generals/guan_4.png', gen_guan_5: 'assets/sprites/generals/guan_5.png',
  gen_zhao_4: 'assets/sprites/generals/zhao_4.png', gen_zhao_5: 'assets/sprites/generals/zhao_5.png',
  gen_ma_4: 'assets/sprites/generals/ma_4.png', gen_ma_5: 'assets/sprites/generals/ma_5.png',
  gen_zhuge_4: 'assets/sprites/generals/zhuge_4.png', gen_zhuge_5: 'assets/sprites/generals/zhuge_5.png',
  gen_liao_4: 'assets/sprites/generals/liao_4.png', gen_liao_5: 'assets/sprites/generals/liao_5.png',
  gen_zhou_4: 'assets/sprites/generals/zhou_4.png', gen_zhou_5: 'assets/sprites/generals/zhou_5.png',
  gen_madai_4: 'assets/sprites/generals/madai_4.png', gen_madai_5: 'assets/sprites/generals/madai_5.png',
...
export function generalSprite(id, level = 1) {
  for (let s = Math.min(level, BAL.MAX_TOWER_LEVEL); s >= 1; s--) {
