...
export const LEVELS = [
  {
    ...
    terrainParams: { ruggedness: 0.28, peaks: 3, platforms: 1, caves: 0 },
    playerCount: 3,
    enemyCount: 2,
    aiError: 0.9,
    wind: 0,
  },
  {
    ...
    terrainParams: { ruggedness: 0.42, peaks: 4, platforms: 2, caves: 0 },
    playerCount: 3,
    enemyCount: 3,
    aiError: 0.7,
    wind: 0,
  },
  {
    ...
    terrainParams: { ruggedness: 0.38, peaks: 3, platforms: 1, caves: 0 },
    playerCount: 3,
    enemyCount: 3,
    aiError: 0.55,
    wind: 0,
  },
  {
    ...
    terrainParams: { ruggedness: 0.55, peaks: 5, platforms: 3, caves: 2 },
    playerCount: 3,
    enemyCount: 3,
    aiError: 0.4,
    wind: 0,
  },
  {
    ...
    terrainParams: { ruggedness: 0.48, peaks: 4, platforms: 4, caves: 0 },
    playerCount: 3,
    enemyCount: 3,
    aiError: 0.28,
    wind: 0,
  },
  {
    ...
    terrainParams: { ruggedness: 0.8, peaks: 6, platforms: 2, caves: 2 },
    playerCount: 3,
    enemyCount: 4,
    aiError: 0.12,
    wind: 0,
