...
export const LEVELS = [
  { id: 1, name: '废土前哨', waves: [ wave([g('normal', 10, 0.55)]), wave([g('normal', 16, 0.4)]) ] },
  { id: 2, name: '断桥', waves: [ wave([g('normal', 12, 0.5)]), wave([g('fast', 8, 0.45), g('normal', 10, 0.5)]) ] },
  ...
  { id: 5, name: '高速公路', waves: [ wave([g('fast', 10, 0.4)]), wave([g('shielded', 4, 1.0)]), wave([g('tank', 3, 1.2), g('normal', 12, 0.45)]) ] },
  ...
  { id: 8, name: '军火库', waves: [ wave([g('shielded', 6, 0.9)]), wave([g('exploder', 6, 0.9), g('spitter', 4, 1.0)]), wave([g('tank', 3, 1.1)]) ] },
